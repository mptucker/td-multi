...
import { ParadiseHome } from "@/components/paradise/ParadiseHome";
...
export default async function HomePage({ params }: { params: Promise<{ brand: string }> }) {
  ...
  if (brand.slug === "paradise") return <ParadiseHome brand={brand} />;
  ...
  if (brand.slug === "water-taxi") {
    return <WaterTaxiHome brand={brand} content={content} />;
  }
